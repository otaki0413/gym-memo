...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/gym-memo)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gym-memo
```

A live public deployment of this template is available at [https://gym-memo.templates.workers.dev](https://gym-memo.templates.workers.dev)
